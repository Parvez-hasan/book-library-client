...
id: 2,
name: "Parvez",
image: "https://i.ibb.co.com/TMRKztGY/417029541-2540453809460511-619514336146760614-n-removebg-preview.png",
...
id: 4,
name: "Nishat",
image: "https://i.ibb.co.com/LdsWDFPr/casual-hair-female-beautiful-street.jpg",
text: "A perfect platform for book lovers. Highly recommended!",
},
{
id: 5,
name: "Sabbir",
image: "https://i.ibb.co.com/q3yM5zxj/Whats-App-Image-2024-11-24-at-06-48-29-405d3764.jpg",
text: "Loved the clean UI and lightning-fast service!",
},
{
id: 6,
name: "Marissa",
image: "https://i.ibb.co.com/x8qrhrjC/427725259-361283546867809-4276318470941113782-n-removebg-preview.png",
text: "Book delivery and return process is super smooth.",
},
{
id: 7,
name: "Tanvir",
image: "https://i.ibb.co.com/ZpHwKV8j/funny-smiling-hipster-handsome-man-guy-stylish-summer-cloth-street-sunglasses.jpg",
      ...
      slidesPerView={4}
       ...
       <div className="py-8 p-4 container mx-auto">
          <h2 className="text-2xl text-center font-semibold mb-4">What people say</h2>
          {
            items.map(item =>(
              <SwiperSlide>
              <div key={item.id} className="p-4  border rounded bg-white dark:bg-slate-800">
                  <p className="text-gray-600 dark:text-gray-300 text-center">"{item.text}"</p>
                   <div className='flex justify-between items-center p-3 '>
                  
                      <img className='h-14 w-14 rounded-full' src={item.image} alt="" />
