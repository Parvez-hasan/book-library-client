...
const AboutUs = () => {
  return (
    <section className="max-w-7xl mx-auto p-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-5 rounded-xl shadow bg-pink-200">
          ...
          <div className="p-5 rounded-xl shadow dark:text-gray-800 bg-pink-200">
