...
const AdminDashboard = () => {
    ...
    <div className="min-h-screen bg-linear-to-br from-blue-100 to-blue-300 p-6">
      ...
      <p className="text-center text-gray-600 mb-10">
        Manage the entire Book Courier platform
      </p>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        {/*  Orders */}
        <DashboardCard
          icon={<FaTruckMoving className="text-5xl text-blue-600" />}
...
const DashboardCard = ({ icon, title, desc }) => {
  return (
    <div className="p-6 bg-white/80 backdrop-blur-md shadow-xl dark:text-gray-800 hover:shadow-2xl cursor-pointer rounded-2xl border border-blue-100 hover:-translate-y-1 transition-all duration-300">
